...
export default function App() {
  ...
  return (
    <div className="min-h-screen text-white font-mono selection:bg-[#ff7a45]/30 flex flex-col">
      {/* Floating Navbar */}
      <div className="fixed top-4 inset-x-0 z-50 flex justify-center pointer-events-none px-4">
        ...
        >
          <PixelCorners color="rgba(255,122,69,0.5)" size={6} thick={2} />
          ...
          <nav className="flex items-center gap-1">
            {(['library', 'docs'] as const).map((view) => (
              <button
                ...
                className="relative px-4 py-1.5 text-[10px] tracking-widest font-bold transition-colors"
                style={{ borderRadius: 0 }}
              >
                {currentView === view && (
                  <motion.div
                ...
                {currentView === view && <PixelCorners color="rgba(255,122,69,0.6)" size={4} thick={1} />}
          ...
          <a
            ...
            className="relative flex items-center gap-2 px-3 py-1.5 border border-white/10 bg-white/[0.03] hover:border-[#ff7a45]/50 hover:bg-[#ff7a45]/5 transition-all group"
            style={{ borderRadius: 0 }}
          >
            <PixelCorners color="rgba(255,122,69,0.4)" size={4} thick={1} />
            {/* Pixel star icon */}
            ...
            <span className="text-[9px] font-bold text-[#ff7a45]/70 bg-[#ff7a45]/10 px-1.5 py-0.5 border border-[#ff7a45]/20 min-w-[1.5rem] text-center" style={{borderRadius:0}}>
            ...
            <div className="max-w-[1400px] mx-auto px-6 md:px-12 pt-14 pb-0 grid md:grid-cols-[1fr_auto] gap-12 items-center">
              ...
              <div className="pb-16 md:pb-20">
                ...
                <motion.div
                  ...
                  style={{ borderRadius: 0 }}
                >
                  <PixelCorners color="rgba(255,122,69,0.8)" size={5} thick={1} />
                  <motion.span
                ...
                >
                  {[
                    ...
                    <div key={label} className="relative border border-white/[0.06] px-4 py-3 bg-white/[0.015] group hover:border-white/10 transition-colors" style={{ borderRadius: 0 }}>
                      <PixelCorners color={`${accent}55`} size={6} thick={1} />
            ...
            <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-6 mb-12 sticky top-[72px] bg-[#07070a]/96 backdrop-blur-md py-4 z-30 border-b border-white/[0.06]">
              ...
              <div className="relative w-full md:w-80">
                ...
                <input
                  ...
                  className="w-full bg-white/[0.02] border border-white/10 rounded-sm py-3 pl-11 pr-4 text-xs tracking-wider text-white placeholder:text-white/20 focus:outline-none focus:border-[#ff7a45]/50 focus:bg-white/[0.05] transition-all"
                />
              </div>
            </div>
              ...
              {filteredIcons.map((icon) => (
                ...
                >
                  ...
                  <motion.span
                    ...
                    variants={{ initial: { opacity: 0.15, color: '#ffffff' }, active: { opacity: 0.7, color: `rgb(${icon.color1[0]},${icon.color1[1]},${icon.color1[2]})` } }}
                    transition={{ duration: 0.2 }}
                  >
                    {icon.id}
                  </motion.span>
            ...
            >
              ...
              <div className="flex items-center justify-between px-7 py-4 border-b border-white/5">
                <div className="flex items-center gap-3">
                  <span className="relative text-[9px] tracking-[0.2em] text-white/40 uppercase border border-white/10 px-2.5 py-1">{selectedIcon.category}<PixelCorners color="rgba(255,255,255,0.15)" size={4} thick={1} /></span>
                ...
                <button onClick={() => setSelectedIcon(null)} className="text-white/20 hover:text-white/80 transition-colors p-1.5 hover:bg-white/5 rounded-lg">
                  <X size={18} />
                </button>
              </div>
              ...
              <div className="flex flex-col md:flex-row">
                ...
                <div className="w-full md:w-72 border-t md:border-t-0 md:border-l border-white/5 flex flex-col">
                  <div className="px-6 py-5 border-b border-white/5">
                    ...
                    <div className="flex items-center gap-1 bg-white/[0.04] p-1 border border-white/5 w-fit">
                      <button
                        onClick={() => setDialogAnimateOn('always')}
                        className={`relative px-3 py-1.5 text-[10px] tracking-wider font-bold transition-all ${dialogAnimateOn === 'always' ? 'bg-white text-black' : 'text-white/30 hover:text-white'}`}
                        style={{ borderRadius: 0 }}
                      >
                        {dialogAnimateOn === 'always' && <PixelCorners color="rgba(0,0,0,0.3)" size={4} thick={1} />}
                        ALWAYS
                      </button>
                      <button
                        onClick={() => setDialogAnimateOn('hover')}
                        className={`relative px-3 py-1.5 text-[10px] tracking-wider font-bold transition-all ${dialogAnimateOn === 'hover' ? 'bg-white text-black' : 'text-white/30 hover:text-white'}`}
                        style={{ borderRadius: 0 }}
                      >
                        {dialogAnimateOn === 'hover' && <PixelCorners color="rgba(0,0,0,0.3)" size={4} thick={1} />}
                        ON HOVER
                      </button>
                    </div>
                  </div>
                    ...
                    <div className="grid grid-cols-2 gap-2">
                      {([
                        ...
                        <button
                          ...
                          className={`relative flex items-center gap-2 px-3 py-2.5 text-xs font-bold tracking-wide transition-all ${
                            dialogAnimation === type
                              ? 'bg-[#ff7a45] text-black'
                              : 'bg-white/[0.04] text-white/40 hover:text-white hover:bg-white/10 border border-white/5'
                          }`}
                        style={{ borderRadius: 0 }}
                        >
                          <PixelCorners
                            color={dialogAnimation === type ? 'rgba(0,0,0,0.3)' : 'rgba(255,255,255,0.12)'}
                            size={4} thick={1}
                          />
                          {icon}
                          {label}
                  ...
                  <div className="px-6 pb-6">
                    <button
                      ...
                      className="relative w-full bg-white text-black py-3 text-xs font-bold tracking-widest hover:bg-white/90 transition-all flex items-center justify-center gap-2"
                      style={{ borderRadius: 0 }}
                    >
...
function FilterButton({ active, onClick, icon, label }: { active: boolean, onClick: () => void, icon: React.ReactNode, label: string }) {
  return (
    <button
      onClick={onClick}
      style={{ borderRadius: 0 }}
      className={`relative flex items-center gap-2 px-4 py-2 text-[10px] tracking-widest transition-all whitespace-nowrap font-bold ${
        active
          ? 'bg-[#ff7a45] text-black'
          : 'bg-white/[0.03] border border-white/[0.07] text-white/35 hover:text-white hover:border-white/20 hover:bg-white/[0.06]'
      }`}
    >
      <PixelCorners
        color={active ? 'rgba(0,0,0,0.25)' : 'rgba(255,255,255,0.15)'}
        size={5} thick={1}
      />
      {icon}
      {label}
    ...
    <div className="w-full pb-24">
        ...
        <div className="max-w-5xl mx-auto px-6 md:px-12 py-12 md:py-16 flex flex-col md:flex-row items-start md:items-end justify-between gap-8">
          <div>
            <motion.div
              ...
              style={{ borderRadius: 0 }}
            >
              <PixelCorners color="rgba(0,200,255,0.6)" size={5} thick={1} />
      ...
      <div className="max-w-5xl mx-auto px-6 md:px-12 mt-8 grid grid-cols-1 lg:grid-cols-[1fr_300px] gap-6">
        ...
        <div className="space-y-6">
          ...
          {/* Step 1 */}
          <div className="relative border border-white/[0.07] bg-[#0a0a0a] overflow-hidden" style={{borderRadius:0}}>
            <PixelCorners color="rgba(255,122,69,0.35)" size={7} thick={1} />
            <div className="flex items-center gap-3 px-6 py-4 border-b border-white/[0.05] bg-white/[0.02]">
              <span className="relative w-6 h-6 flex items-center justify-center bg-[#ff7a45] text-black text-[10px] font-bold" style={{borderRadius:0}}><PixelCorners color="rgba(0,0,0,0.3)" size={4} thick={1} />1</span>
          ...
          {/* Step 2 */}
          <div className="relative border border-white/[0.07] bg-[#0a0a0a] overflow-hidden" style={{borderRadius:0}}>
            <PixelCorners color="rgba(0,200,255,0.35)" size={7} thick={1} />
            <div className="flex items-center gap-3 px-6 py-4 border-b border-white/[0.05] bg-white/[0.02]">
              <span className="relative w-6 h-6 flex items-center justify-center bg-[#00c8ff] text-black text-[10px] font-bold" style={{borderRadius:0}}><PixelCorners color="rgba(0,0,0,0.3)" size={4} thick={1} />2</span>
            ...
            <div className="px-6 py-5">
              ...
              <button className="relative w-full border border-white/10 bg-white/[0.03] hover:bg-white/[0.07] text-white/70 hover:text-white py-3 text-xs font-bold tracking-widest transition-colors flex items-center justify-center gap-2" style={{borderRadius:0}}>
                <PixelCorners color="rgba(255,255,255,0.2)" size={5} thick={1} />
          ...
          {/* Step 3 — code block */}
          <div className="relative border border-white/[0.07] bg-[#0a0a0a] overflow-hidden" style={{borderRadius:0}}>
            <PixelCorners color="rgba(168,85,247,0.35)" size={7} thick={1} />
            <div className="flex items-center gap-3 px-6 py-4 border-b border-white/[0.05] bg-white/[0.02]">
              <span className="relative w-6 h-6 flex items-center justify-center bg-purple-500 text-black text-[10px] font-bold" style={{borderRadius:0}}><PixelCorners color="rgba(0,0,0,0.3)" size={4} thick={1} />3</span>
              <h2 className="text-sm font-bold tracking-wide">Use It</h2>
            </div>
            <div className="relative overflow-x-auto">
              <button className="absolute top-3 right-4 text-white/20 hover:text-white/60 transition-colors z-10">
                <Copy size={13} />
              </button>
...
/>`}
          ...
          {/* Props table */}
          <div className="relative border border-white/[0.07] bg-[#0a0a0a] overflow-hidden" style={{borderRadius:0}}>
            <PixelCorners color="rgba(255,255,255,0.18)" size={7} thick={1} />
        ...
        <div className="space-y-6">
          <div className="relative border border-white/[0.07] bg-[#0a0a0a] overflow-hidden lg:sticky lg:top-24" style={{borderRadius:0}}>
            <PixelCorners color="rgba(255,255,255,0.2)" size={7} thick={1} />
